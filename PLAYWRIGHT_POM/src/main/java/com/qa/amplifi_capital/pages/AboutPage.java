...
public class AboutPage {
    ...
    private String UatAboutPageUrl = "https://uat.amplificapital.com/about";
    private String ProdAboutPageUrl = "https://www.amplificapital.com/about";
    // private String aboutLink = "(//a[contains(text(),'About')])[1]";

    // 2. page constructor
    public AboutPage(Page page, BrowserContext context) {
        this.page = page;
    ...
    public void ValidateAboutPageContents() {
        ...
        tabs.navigate(ProdAboutPageUrl);
