...
public class InvestorsPage {
	 ...
	 private Page page;
	    ...
	    private String UatInvestorsPageUrl = "https://uat.amplificapital.com/our-services-for-investors";
	    private String ProdInvestorsPageUrl = "https://www.amplificapital.com/our-services-for-investors";

	    // 2. page constructor
	    public InvestorsPage(Page page, BrowserContext context) {
	        this.page = page;
	        this.context = context;
	    }

	    // 3. page actions/Methods
	    public String getInvestorsPageTitle() {
	    ...
	    // 4. get home page url
	    public String getInvestorsPageURL() {
	        String url = page.url();
	    ...
	    // Validate buttons
	    public List<String> ValidateInvestorsButtons() {
	        ...
	        for (int j = 0; j < count_home_buttons; ++j) {
	            ...
	            page.waitForTimeout(2000);
	            page.navigate(UatInvestorsPageUrl);
	            page.waitForTimeout(2000);
	    ...
	    public void ValidateInvestorsPageContents() {
	        ...
	        tabs.navigate(ProdInvestorsPageUrl);
